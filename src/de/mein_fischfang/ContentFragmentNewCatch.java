 ...
 * @version 1.0.0
 */
public class ContentFragmentNewCatch extends ContentFragment
{
     ...
     */
    public ContentFragmentNewCatch(final CharSequence csTitle, final int iIndicatorColor, final int iDividerColor)
    {
        mTitle = csTitle;
    ...
    {
        return inflater.inflate(R.layout.page_new_catch, container, false);
    }
    ...
    public final void onViewCreated(View view, Bundle savedInstanceState)
    {
        ...
        TextView title = (TextView) view.findViewById(R.id.new_catch_title);
        title.setText("Neue Fänge hier");
    }
