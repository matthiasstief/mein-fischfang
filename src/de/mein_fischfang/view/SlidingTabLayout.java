...
package de.mein_fischfang.view;
...
/**
 * <b>Title:</b> SlidingTabLayout <br>
 * <b>Description:To be used with ViewPager to provide a tab indicator component which give constant feedback as to the user's scroll progress.
 * <p>
 * To use the component, simply add it to your view hierarchy. Then in your {@link android.app.Activity} or {@link android.support.v4.app.Fragment} call
 * {@link #setViewPager(ViewPager)} providing it the ViewPager this layout is being used for.
 * <p>
 * The colors can be customized in two ways. The first and simplest is to provide an array of colors via {@link #setSelectedIndicatorColors(int...)} and
 * {@link #setDividerColors(int...)}. The alternative is via the {@link TabColorizer} interface which provides you complete control over which color is used for
 * any individual position.
 * <p>
 * The views used as tabs can be customized by calling {@link #setCustomTabView(int, int)}, providing the layout ID of your custom layout.</b> <br>
 *
 * @author Google
 */
public class SlidingTabLayout extends HorizontalScrollView
{
     ...
     *
     * If you only require simple custmisation then you can use {@link #setSelectedIndicatorColors(int...)} and {@link #setDividerColors(int...)} to achieve
     * similar effects.
     *
    ...
    /**
     * <b>Title:</b> InternalViewPagerListener <br>
     * <b>Description:</b> <br>
     *
     * @author Google
     */
