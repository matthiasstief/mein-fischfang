...
class SlidingTabStrip extends LinearLayout
{
     ...
     *
     * @param customTabColorizer SlidingTabLayout.TabColorizer
     */
     ...
     * blendColors
     *
     * Blend {@code color1} and {@code color2} using the given ratio. Param ratio of which to blend. 1.0 will return {@code color1}, 0.5 will give an even
     * blend, 0.0 will return {@code color2}.
     *
     * @param color1 int
     * @param color2 int
     * @param ratio float
    ...
    /**
     * <b>Title:</b> SimpleTabColorizer <br>
     * <b>Description:</b> <br>
     *
     * @author Google
     */
